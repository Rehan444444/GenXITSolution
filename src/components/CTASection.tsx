  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-10">
        ...
        <div className="absolute -bottom-20 -left-20 w-80 h-80 rounded-full bg-gray-700"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            ...
            <a
              href="/services"
              className="bg-transparent hover:bg-white/10 text-black border border-white/30 py-3 px-8 rounded-md transition-colors flex items-center font-medium"
            >
